...
namespace SistemaPeliculas.Controllers
{
    public class AdminController : Controller
    {
        ...
        public IActionResult CrearRestriccion()//falta vista
        {
            return View();
        }
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> EliminarRestriccionConfirmado(int id)///falta vista
        {
            var restriccion = await _context.Restricciones.FindAsync(id);
        ...
        // Acción para mostrar una vista de confirmación (opcional)
